...
You may also have to install a YAML library:
...
Finally, you needed to tell RVM where OpenSSL was located when installing Ruby 2.0.0:
...
You sould create a gemset with a random name eg NITOSPortal 

  $ rvm use 2.0.0@NITOSPortal --create --default

2.Install RubyGems

  $ which gem

If you already have RubyGems installed, you should make sure your system uses the version tha we used for the Portal's development:
...
6.Database settings on the new rails application
